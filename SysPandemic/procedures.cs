    ...
    public partial class procedures : Form
    {
        ...
        private void buscar()
        {
            ...
            try
            {
                ...
                {
                    string status = "NO PAGADO";
                    string query = "Select idprocedure as ID, idpatient as IdPaciente, namepatient as Paciente, iddoctor as IdDoctor, namedoctor as Doctor, [procedure] as Procedimiento, tooth as Diente, realprice as Precio, iscoverage as Cobertura, pricepay as Total, statuspay as Credito, dateprocedure as Fecha from [procedure] where statuspay = '" + status + "' and pricepay > 0 and ptype = '"+scondition_txt.Text+ "' order by ID desc ";
                    c.load_dgv(dataGridView1, query);
                }
                else if (spay_rbtn.Checked)
                {
                ...
                {
                    string query = "Select idprocedure as ID, idpatient as IdPaciente, namepatient as Paciente, iddoctor as IdDoctor, namedoctor as Doctor, [procedure] as Procedimiento, tooth as Diente, realprice as Precio, iscoverage as Cobertura, pricepay as Total, statuspay as Credito, dateprocedure as Fecha from [procedure] where pricepay > 0 and ptype = '" + scondition_txt.Text + "' order by ID desc ";
                    c.load_dgv(dataGridView1, query);
                }
                else if (sid_rbtn.Checked)
                {
                    string query = "Select idprocedure as ID, idpatient as IdPaciente, namepatient as Paciente, iddoctor as IdDoctor, namedoctor as Doctor, [procedure] as Procedimiento, tooth as Diente, realprice as Precio, iscoverage as Cobertura, pricepay as Total, statuspay as Credito, dateprocedure as Fecha from [procedure] where idprocedure like '%" + search_txt.Text + "%' and pricepay > 0 and ptype = '" + scondition_txt.Text + "' order by ID desc ";
                    c.load_dgv(dataGridView1, query);
                }
                else if (spatient_rbtn.Checked)
                {
                    string query = "Select idprocedure as ID, idpatient as IdPaciente, namepatient as Paciente, iddoctor as IdDoctor, namedoctor as Doctor, [procedure] as Procedimiento, tooth as Diente, realprice as Precio, iscoverage as Cobertura, pricepay as Total, statuspay as Credito, dateprocedure as Fecha from [procedure] where namepatient like '%" + search_txt.Text + "%' and pricepay > 0 and ptype = '" + scondition_txt.Text + "' order by ID desc";
                    c.load_dgv(dataGridView1, query);
                }
                else if (sdoctor_rbtn.Checked)
                {
                    string query = "Select idprocedure as ID, idpatient as IdPaciente, namepatient as Paciente, iddoctor as IdDoctor, namedoctor as Doctor, [procedure] as Procedimiento, tooth as Diente, realprice as Precio, iscoverage as Cobertura, pricepay as Total, statuspay as Credito, dateprocedure as Fecha from [procedure] where namedoctor like '%" + search_txt.Text + "%' and pricepay > 0 and ptype = '" + scondition_txt.Text + "' order by ID desc";
                    c.load_dgv(dataGridView1, query);
                }
                else if (sprocedure_rbtn.Checked)
                {
                    string query = "Select idprocedure as ID, idpatient as IdPaciente, namepatient as Paciente, iddoctor as IdDoctor, namedoctor as Doctor, [procedure] as Procedimiento, tooth as Diente, realprice as Precio, iscoverage as Cobertura, pricepay as Total, statuspay as Credito, dateprocedure as Fecha from [procedure] where procedure like '%" + search_txt.Text + "%' and pricepay > 0 and ptype = '" + scondition_txt.Text + "' order by ID desc";
                    c.load_dgv(dataGridView1, query);
                }
